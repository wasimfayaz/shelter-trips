            ...
            <div className={`${styles.slowTravelImage} reveal`}>
              <div className={styles.imageStack}>
                <div className={styles.imgMain}>
                  ...
                  <img 
                    src="https://theurgetowander.com/wp-content/uploads/2017/06/dsc_0864-copy.jpg" 
                    alt="Kashmiri Houseboat" 
                    className={styles.imgMainTag} 
                  />
                </div>
                <div className={styles.imgSecond}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img 
                    src="https://images.pexels.com/photos/11414716/pexels-photo-11414716.jpeg" 
                    alt="Dal Lake View" 
                    className={styles.imgSecondTag} 
                  />
                </div>
