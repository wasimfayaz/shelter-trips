  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await sendEmailToShelterTrips({
        ...
        email: form.email,
        phone: form.phone,
        inquiryType: 'Car Rental',
        arrivalDate: form.date,
        duration: `${form.days} Days`,
        message: `Vehicle Preference: ${form.cabType} | Route/Notes: ${form.route || 'N/A'} | Details: ${form.message || 'N/A'}`,
      });
    } catch (err) {
      console.error('Cab booking form error:', err);
    } finally {
      setSent(true);
    }
  };
              ...
              <div className={styles.contactDetails}>
                <div className={styles.contactItem}>
                  ...
                  <div>
                    ...
                    <span className={styles.contactValue}>+91 84939 24278 / +91 910-366-2018</span>
                  </div>
                </div>
                <div className={styles.contactItem}>
            ...
            <div className={`${styles.formContainer} reveal revealDelay1`}>
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className={styles.glassForm} id="cab-booking-form">
                  ...
                  <a
                    href={`https://wa.me/918493924278?text=Hi%2C%20I%20am%20interested%20in%20booking%20a%20cab%20rental.`}
                    target="_blank"
