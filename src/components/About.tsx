      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.right} reveal revealDelay1`}>
          ...
          <div className={styles.pillars}>
            {[
              { icon: '◆', title: 'Customized', desc: 'Every tour is made for your preferences, not a template.' },
              { icon: '◆', title: 'Local Guides', desc: 'Born & raised in Kashmir. We know all the best places.' },
              { icon: '◆', title: '24/7 Support', desc: 'Personal support from planning until your return home.' },
            ].map((p) => (
