  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.printHeader}>
        ...
        <div className={styles.printSub}>Official Terms, Conditions & Payment Policy Document</div>
      ...
      <article className={styles.article}>
        ...
        <div className={`${styles.topRow} ${styles.noPrint}`}>
          <Link href="/" className={styles.backBtn} id="terms-back-home">
            ← Back to Home
          </Link>
        ...
        <header className={styles.header}>
          <span className={styles.badge}>OFFICIAL POLICY & PAYMENT PORTAL</span>
