      ...
      <div className={styles.container}>
        <div className={styles.left}>
          ...
          <div className={styles.contactInfo}>
            <a href="tel:+917006655655" className={styles.infoItem} id="contact-phone">
              ...
              <div>
                ...
                <span className={styles.infoValue}>+91 70066 55655</span>
              </div>
            </a>
          ...
          <div className={styles.social}>
            ...
            <div className={styles.socialLinks}>
              ...
              <a href="https://wa.me/917006655655" className={styles.socialLink} target="_blank" rel="noopener noreferrer" id="social-whatsapp">WhatsApp</a>
            </div>
          </div>
        </div>
