    ...
    <section className={styles.hotels} id="hotels">
      <div className="container">
        ...
        <div className={`${styles.mainHeader} reveal`}>
          <p className="section-label">Hotels & Stays</p>
          <h2 className="section-title">Luxury <em>Hotels & Stays</em></h2>
          <p className={styles.mainDesc}>
            Handpicked luxury hotels and houseboats designed to make your stay in Kashmir and Ladakh truly memorable.
          </p>
        </div>
