    ...
    <main style={{ backgroundColor: '#fafafa', minHeight: '100vh', color: '#0a0a0a' }}>
      ...
      <article style={{ maxWidth: '800px', margin: '0 auto', padding: '160px 40px 100px', fontFamily: 'var(--font-sans)' }}>
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: '32px', fontSize: '15px', fontWeight: 300, lineHeight: 1.8, color: '#333333' }}>
          <p>
            At Shelter Trips, we are dedicated to protecting the privacy and security of our guests. This Privacy Policy details how we collect, use, and safeguard your personal information when you use our website, enquire about tour packages, or book houseboats and hotels in Kashmir.
          </p>
          ...
          <div>
            ...
            <p style={{ marginTop: '10px', fontWeight: 500 }}>
              ...
              WhatsApp/Call: +91 84939 24278 / +91 910-366-2018
            </p>
          </div>
        </section>
