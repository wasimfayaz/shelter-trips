...
const hotelsDetails: { [key: string]: any } = {
  'shelter-group-houseboats': {
    ...
    tableDetails: [
      ...
      { label: 'CONTACT', value: '+91 84939 24278 / +91 910-366-2018' }
    ],
...
export default function HotelDetailClient({ id }: { id: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await sendEmailToShelterTrips({
        formType: id === 'shelter-heritage' ? 'HOTEL SHELTER HERITAGE ENQUIRY' : 'Trip Inquiry',
        name: form.name,
        email: form.email,
        phone: form.phone,
        inquiryType: 'Hotel Reservation',
        destinationNeeded: hotel.name,
        arrivalDate: form.checkin,
        duration: `Check-out: ${form.checkout}`,
        travelers: id === 'shelter-heritage' ? `${form.roomsCount} Room(s)` : `${form.roomsCount} Room(s) - ${form.roomType}`,
  ...
  return (
    <main className={styles.main}>
      ...
      <header className={styles.hero} style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.75)), url('${hotel.image}')` }}>
        <div className={styles.heroContent}>
          <div className={styles.container}>
            ...
            {id !== 'shelter-heritage' && <div className={styles.priceBadge}>{hotel.price}</div>}
          </div>
        </div>
      </header>
          ...
          <div className={styles.aboutPropertyGrid}>
            ...
            <div className={`${styles.aboutLeft} reveal`}>
              ...
              <div className={styles.aboutActions}>
                ...
                <a href="tel:+918493924278" className={styles.actionLink} id="hotel-action-call">CALL US</a>
            ...
            <div className={styles.contentLeft}>
              ...
              <div className={styles.amenitiesBox}>
                <h3 className={styles.boxTitle}>
                  {id === 'shelter-heritage' ? 'Facilities :' : 'Premium Amenities'}
                </h3>
              ...
              <div className={styles.stickyCard}>
                {sent ? (
                  ...
                  <form onSubmit={handleSubmit} className={styles.glassForm} id="hotel-booking-form">
                    ...
                    <div className={styles.inputRow}>
                      ...
                      <div className={styles.inputGroup}>
                        ...
                        <input 
                          ...
                          id="hotel-checkout" 
                          name="checkout" 
                          placeholder="e.g. 17 Oct or DD/MM/YYYY"
                          value={form.checkout}
                          onChange={handleChange}
                          className={styles.inputField}
                        />
                    ...
                    <a 
                      href={`https://wa.me/918493924278?text=Hi%2C%20I%20am%20interested%20in%20booking%20at%20${encodeURIComponent(hotel.name)}.`}
                      target="_blank" 
                      rel="noopener noreferrer"
      ...
      <Footer />
      <StickyButtons offsetBottom={id === 'shelter-heritage'} />
      <ScrollReveal />
      ...
      {id === 'shelter-heritage' && (
        <a 
          ...
          id="heritage-sticky-phone"
        >
          <span style={{ fontSize: 'clamp(15px, 4.5vw, 20px)', fontWeight: '700', letterSpacing: '0.03em', color: '#000000' }}>
            Call +91 84939 24278
          </span>
